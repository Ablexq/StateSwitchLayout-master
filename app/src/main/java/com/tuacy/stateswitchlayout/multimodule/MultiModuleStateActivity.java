...
public class MultiModuleStateActivity extends AppCompatActivity {
	...
	private void initView() {
		...
		mStateLayout0 = (StateLayout) findViewById(R.id.layout_state_0);
		mStateLayout1 = (StateLayout) findViewById(R.id.layout_state_1);
		mStateLayout2 = (StateLayout) findViewById(R.id.layout_state_2);
	}
