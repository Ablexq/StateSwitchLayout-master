...
public class CustomerStateActivity extends AppCompatActivity {
	...
	private void initView() {
		...
		mSmartRefreshLayout = (SmartRefreshLayout) mStateLayout.getContentView().findViewById(R.id.refresh_customer);
		RecyclerView recyclerView = (RecyclerView) mStateLayout.getContentView().findViewById(R.id.recycler_customer);
